...
<html>
 ...
 <?php
      ...
      echo "<a href='drinkpage.php?did=",$drink_id,"'>";
			echo"<img src='images/",$photo,"'>";
      echo "</a>";
            echo "</div>";
            echo"<div class='post-info-container'>";
			echo"<a href='drinkpage.php?did=",$drink_id,"' class='post-title'>",$title,"</a> <span class='post-price'>",$likes," Likes </span> <br><span class='post-city'>",$description,"</span>";
