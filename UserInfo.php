  <?php
            ...
            try {
                  ...
                  $res = $pdo->prepare("SELECT Title, Description FROM Drink WHERE Username = ?");
                  ...
                  echo json_encode(array($data, $description, $comment, $drink, $dusername, $likeUser, $likeTitle, $bday, $first, $last, $email));
